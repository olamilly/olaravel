...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::patch('/todo/{id}', [App\Http\Controllers\Api\todoController::class, 'update']); //update todo item 
    Route::patch('/todo/{id}/complete', [App\Http\Controllers\Api\todoController::class, 'complete']);//mark item as completed
    Route::delete('/todo/{id}', [App\Http\Controllers\Api\todoController::class, 'delete']);//delete todo item
});
